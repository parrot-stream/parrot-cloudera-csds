...
function usage {
  ...
  echo -e "  Example:"
  echo -e ""
  echo -e "    ./jks-cert.sh create -a=schema-registry -h=quickstart.cloudera -sd=/opt/cloudera/security"
  echo -e "    ./jks-cert.sh delete -a=schema-registry -sd=/opt/cloudera/security"
  echo -e "    ./jks-cert.sh list   -sd=/opt/cloudera/security"
  echo -e ""
  echo -e "  Commands:"
  echo -e ""
